...
void main(List<String> arguments) {
  print('''
    ...
    (2) - verificar aprovação pela maior nota; 
  ...
  if (escolha == 1) {
    aprovado =
        verificarAprovacao(nota1: n1, nota2: n2, caclularNota: calcularMedia);
  } else if (escolha == 2) {
    aprovado = verificarAprovacao(
        nota1: n1,
        nota2: n2,
        caclularNota: (double nota1, double nota2) {
          double maior = nota1;
...
bool verificarAprovacao(
    ...
    required Function caclularNota}) {
...
void validarNota(
    {required double nota1, required double nota2, double limiteNota = 10}) {
  var notaMinima = 0.0;
